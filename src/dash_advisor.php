...
<div class="inside">
    ...
    <ul class="nav nav-pills">
        ...
        <li><a href="#3a" data-toggle="tab">Students</a>
        </li>
    ...
    <div class="tab-content clearfix">
        ...
        <div class="tab-pane" id="3a">
            <h2>Users</h2>
            <button id="allStudents" style="float: right" type="button" class="btn btn-primary">All Students</button>
            <button id="pendingStudents" style="float: right" type="button" class="btn btn-primary">Pending Students</button>
            ...
            <div class="col-md-9" id="approval">
